...
В рамках прохождения учебного курса, студенты должны выполнить лабораторную работу. Лабораторная работа должна содержать отчет и практическое подверждение в виде программной реализации или 3D модели/чертежа.

## Формат лабораторной работы
 
Общий каталог должен быть назван по следующему принципу

YYYY-MM-DD-НавзаниеТемы-Автор1-Автор2

В зависимости от темы лабораторной работы и особенностей её реализации наличие тех или иных файлов и директорий может варироваться, но любая лабораторная работа **обязательно** должна содержать: 
...
Содержание проекта может сильно варироваться в зависимости от используемой технологии. В случае с Python рекомендуется использовать pyenv, который позволит легко перенести ПО на другой компьютер.
...
# Название темы
Краткое описаниние л/р (2-5 предложения). Можно взять из введения отчета.
